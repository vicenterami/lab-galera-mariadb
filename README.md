...
Ahora tienes el repositorio perfecto. Haz los commits de tus últimos cambios:
Bash

git add main.tf ansible/
git commit -m "feat: configuracion de Ansible y cluster Galera MariaDB funcional"
